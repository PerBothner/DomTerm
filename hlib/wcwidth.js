...
DomTerm.prototype.nulWidth = 0;

// Width of a control charater.
DomTerm.prototype.controlWidth = 0;

// Flag whether to consider East Asian Ambiguous characters.
DomTerm.prototype.regardCjkAmbiguous = false;
...
DomTerm.prototype.ambiguousCharsAreWide = function(context) {
    return DomTerm.prototype.regardCjkAmbiguous;
}

// Width of an East Asian Ambiguous character.
DomTerm.prototype.cjkAmbiguousWidth = 2;
 ...
 *     otherwise.
 */
DomTerm.isSpace = function(ucs) {
  // Auxiliary function for binary search in interval table.
  var combining = DomTerm._combining;
...
DomTerm.isWideEastAsian = function(ucs) {
    var table = DomTerm._wideEastAsian;
 ...
 * character.
 */
DomTerm.prototype.isCjkAmbiguous = function(ucs) {
  var ambiguous = DomTerm._ambiguous;
 ...
 */
DomTerm.prototype.wcwidth = function(ucs) {
 ...
 * @return {integer} The column width of the given character.
 */
DomTerm.prototype.charWidthDisregardAmbiguous = function(ucs) {
  ...
  if (DomTerm.isSpace(ucs))
    return 0;

  // If we arrive here, ucs is not a combining or C0/C1 control character.
  return DomTerm.isWideEastAsian(ucs) ? 2 : 1;
};
 ...
 * @return {integer} The column width of the given character.
 */
DomTerm.prototype.charWidthRegardAmbiguous = function(ucs) {
 ...
 */
DomTerm.prototype.strWidth = function(str) {
  var width, rv = 0;
 ...
 */
DomTerm.prototype.substr = function(str, start, opt_width) {
 ...
 * @return {string} The substring.
 */
DomTerm.prototype.substring = function(str, start, end) {
