...
OPTION_F(color_black, "color.black", OPTION_MISC_TYPE)
OPTION_F(color_red, "color.red", OPTION_MISC_TYPE)
OPTION_F(color_green, "color.green", OPTION_MISC_TYPE)
OPTION_F(color_yellow, "color.yellow", OPTION_MISC_TYPE)
OPTION_F(color_blue, "color.blue", OPTION_MISC_TYPE)
OPTION_F(color_magenta, "color.magenta", OPTION_MISC_TYPE)
OPTION_F(color_cyan, "color.cyan", OPTION_MISC_TYPE)
OPTION_F(color_white, "color.white", OPTION_MISC_TYPE)
OPTION_F(color_bright_black, "color.bright-black", OPTION_MISC_TYPE)
OPTION_F(color_bright_red, "color.bright-red", OPTION_MISC_TYPE)
OPTION_F(color_bright_green, "color.bright-green", OPTION_MISC_TYPE)
OPTION_F(color_bright_yellow, "color.bright-yellow", OPTION_MISC_TYPE)
OPTION_F(color_bright_blue, "color.bright-blue", OPTION_MISC_TYPE)
OPTION_F(color_bright_magenta, "color.bright-magenta", OPTION_MISC_TYPE)
OPTION_F(color_bright_cyan, "color.bright-cyan", OPTION_MISC_TYPE)
OPTION_F(color_bright_white, "color.bright-white", OPTION_MISC_TYPE)
OPTION_F(style_blink_rate, "style.blink-rate", OPTION_MISC_TYPE)
OPTION_F(style_caret, "style.caret", OPTION_MISC_TYPE)
OPTION_F(color_caret, "color.caret", OPTION_MISC_TYPE)
OPTION_F(color_selection, "color.selection", OPTION_MISC_TYPE)
...
OPTION_F(output_byte_by_byte, "output-byte-by-byte", OPTION_MISC_TYPE)
...
OPTION_F(log_js_to_server, "log.js-to-server", OPTION_MISC_TYPE)
